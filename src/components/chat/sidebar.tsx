...
export function ChatSidebar({
    ...
    const fetchContacts = async () => {
        ...
        console.log('get_chat_contacts rpc ->', { data, error });
        if (error) {
  ...
  .map((c: any) => ({
    ...
    first_name: c.first_name ?? c.contact_first_name,
    last_name: c.last_name ?? c.contact_last_name,
    role: c.role ?? c.contact_role,
    avatar_url: c.avatar_url ?? c.contact_avatar_url,
  }))
  .filter((c: any) => c.id && c.id !== effectiveUserId);
    ...
    const handleConfirmDelete = async () => {
        ...
        // Use secure RPC to delete conversation (handles RLS)
                                ...
                                filteredConversations.map((conv) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {isMounted && onDeleteConversation && (
                                                <DropdownMenu>
