...
import { ParkinsonsPsychologicalReportFormWrapper } from '@/components/forms/patient-management/parkinsons-psychological-report-form-wrapper'
import { Button } from '@/components/ui/button'
import { Loader2, ArrowLeft } from 'lucide-react'
import { toast } from 'sonner'

export function ParkinsonsPsychologicalFormPageContent() {
  ...
  async function loadData() {
    ...
    try {
      ...
      if (result?.data?.success && result.data.data) {
        ...
        setFormData(result.data.data.forms.parkinsonsPsychologicalReport)
      } else {
      ...
      <div className="max-w-4xl mx-auto bg-white p-4 md:p-8">
        <div className="mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
            Parkinson's Intake Psychological Report
          </h1>
        ...
        <ParkinsonsPsychologicalReportFormWrapper
          managementId={managementId}
          patientFirstName={management.first_name}
          patientLastName={management.last_name}
          isCompleted={management.parkinsons_psychological_report_completed}
